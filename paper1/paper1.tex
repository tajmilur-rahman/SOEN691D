...
\textit{How do developers own code around the system?}
...
Since the release of ``linuxv2.6.13'' till ``linuxv3.11'' 2889 developers out of 14621 worked for the files they owned. They have worked for other files also. So the percentage of working with owned files is 19.82% through out the life time (here 2.6.13 to 3.11).

We examine the contribution in writing code and making churns by the developers. Figure 7 plots the cumulative representation of code churns and ownerships per developer.
