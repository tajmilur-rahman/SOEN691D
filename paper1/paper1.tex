...
We found that there was not a great number of people contributing during the time of merge periods. The number was pretty stedy for every releases while during the development periods we see increasing number of contributions of developers . In figure 3 we see the boxplot showing that around 600 developers contributes during the merge period while in release revelopment period around 1000 developers work and this contribution is in increasing order as shown in figure 4. 

\begin{figure}
\begin{center}
\includegraphics[height=1.7in,width=3.4in]{devMP_RDP_box.png}
...
\textit{How do developers own code around t he system?}

Developers work for the software continuously. Some are working for the core development some are working for the fixing and minor enhancements and some for feature developments, planning to merge new feature with any future release but we would like to understand what amount of changes they make during the time of regular development period and what amount the changes they make during the time of RTR. We also want to know about the code ownership of the developers around the time of release and general code ownership i.e.\ which files a developer has worked making more than 80% chruns in his lifetime.

We examine contribution in writing code and making churns. Figure 6 plots the representation of code churns and ownerships per developer.

(TODO: line chart representing churned files line, owned files line. x-axis : developers, y-axis : files churned)
